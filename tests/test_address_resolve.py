...
CASES = {
    ...
    "подсказка Яндекса не подтверждает сама себя": {
        # Реальный случай: сильно ухудшенное фото Свободы 23 подтвердилось как
        # Свободы 54. Тег порождал гипотезу и сам же давал ей бонус за совпадение
        # с признаком «из фотографии», обходя адрес с настоящим визуальным
        # совпадением на 0.2 балла.
        "expect_top": ("свободы", "23"),
        "expect_corroborated": True,
        "candidates": [
            ("Новороссийский медицинский колледж, ул. Свободы, 23", 0.95),
        ],
